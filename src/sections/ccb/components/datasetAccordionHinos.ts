...
import Obra from '../../../../public/audios/exemplo-da-obra-rick-nascimento.mp3';
import Face from '../../../../public/audios/na-face-um-sorriso-emaiara.mp3';
import MaisFeliz from '../../../../public/audios/ninguem-e-mais-feliz-que-nos-sirley-valdecir.mp3';
import OlhaPraMim from '../../../../public/audios/Deus-olha-pra-mim-thayslaine.mp3';
import Especial from '../../../../public/audios/voce-e-especial-luana-dias.mp3';
import Cana from '../../../../public/audios/cana-trilhada-janaina.mp3';
...
export const dataAccordionHinos = [
  ...
  },
  {
    ...
    audio: Obra,
    hino: [
      'Sempre orando e buscando o nosso Deus',
      'Caminhando e vivendo pela fé',
      'Sabe que se parar de buscar ao seu bom Deus',
      ...
      '',
      'Dividir o que não tem com teu irmão',
      'Mas Deus sabe que é de um sincero coração',
      'Não quer nem saber o que o vizinho diz',
      'Que ser crente nessa igreja não é ser feliz',
      'A ciência não resolve os seus problemas',
      'Por isso ele tem Deus e canta os seus poemas',
      'O segredo do louvor',
      'Sua maior alegria é louvar ao Senhor',
      'Louvai ao Senhor',
      'E louvai a Deus',
      'Todo honra e todo glória seja dada a Deus',
      '',
      'É homem fiel, não desiste',
      'Gosta de levar a alegria a quem está triste',
      'O inimigo quer vê-lo de cabeça baixa',
      'Mas irmão não desanime e fica na batalha',
      'Ele sabe que tem Deus no coração',
      'E na hora da batalha Deus estende a mão',
      '',
      'Dá bom testemunho dentro da igreja',
      'E lá fora honra a Deus com toda certeza',
      'Honra o pai, honra a mãe, honra a sua esposa',
      ...
      'Pede forças pra que possa suportar a tudo',
      'E ainda ora e diz que é servo inútil',
      '',
      'E você que entrou hoje nessa oração',
      'E serviu a Deus de um sincero coração',
      'Só Deus sabe a guerra a prova que está aí',
  ...
  },
  {
    ...
    hino: [
      ...
      'Se alegra dos dons que Deus te emprestou',
